...
<body>
 ...
 <h1>Place an Order</h1>
    <form method="post" action="${pageContext.request.contextPath}/test4" id="order-form">
        ...
        <input type="text" name="member_id" id="member-id" required>
        <br><br>
        <label for="product-code">Product Code: </label>
        <input type="number" name="product_code" id="product-code" required>
        <br><br>
        <label for="odr-amount">Order Amount: </label>
        <input type="number" name="odr_amount" id="odr-amount" required>
        <br><br>
    ...
    <script>
        document.getElementById('order-form').addEventListener('submit', async event => {
            ...
            const response = await fetch('${pageContext.request.contextPath}/test4', {
                method: 'POST',
                body: formData,
            });
            ...
            if (resultJson.order_success) {
                resultDiv.textContent = 'Order success.';
            } else {
